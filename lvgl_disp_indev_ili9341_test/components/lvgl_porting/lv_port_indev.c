...
#define key1 gpio_get_level(25)
#define key2 gpio_get_level(32)
#define key3 gpio_get_level(33)
/*------------------
 * Keypad
 * -----------------*/
...
static uint32_t keypad_get_key(const lv_group_t * group)
{
 ...
 uint8_t keys = 0;
    ...
    if(key1_status[0] != key1_status[1])
    {
        ...
        if(key1_status[1]==0)   
        {
            if(lv_group_get_editing(group)==1)   keys = 3;
            else keys =2;
        }
    }
    ...
    if(key2_status[0] != key2_status[1])
    {
        ...
        if(key2_status[1]==0)   
        {
            if(lv_group_get_editing(group)==1)   keys = 4;
            else keys =1;
        }
    }
